...
alter table public.clientes
  ...
  add column if not exists onboarding_status_at timestamptz,
...
revoke all on function public.process_whatsapp_onboarding_event(
  text, text, text, jsonb, timestamptz, text, jsonb
) from public;
