...
const DEMO_RESPONSES: Record<string, string> = {
  ...
  operacional: "Como Superagente Operacional, posso: gerar pautas e briefings, criar tarefas no Notion/Trello, consultar documentos no Drive, responder dúvidas recorrentes do time e alimentar o dashboard de gestão. Lembre-se que algumas ações dependem das credenciais e permissões das plataformas integradas.",
  default: "Entendi sua pergunta! Como agente de IA da Carcará, posso ajudar com onboarding de clientes, operações internas, geração de conteúdo, consulta de métricas e gestão de implantações. Algumas funcionalidades dependem de integrações ativas (Google Drive, Notion, Trello, WhatsApp). Em que posso ajudar?",
};
